...
/**
	...
	void DemoKeeper::createScene()
	{
		...
		root.at(0)->findWidget("Text")->castType<MyGUI::TextBox>()->setCaption("Press IJKLUO to move the ninja; Press 1 to stop the camera and stick to the ninja; WASD + mouse to explore independently");
